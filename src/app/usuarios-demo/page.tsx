...
export default function UsuariosDemoPage() {
  ...
  async function crearUsuario() {
    ...
    try {
      ...
      setNombre("");
      setMessage(
        `Acceso creado correctamente: ${usuarioDisponible} · Contraseña: ${PASSWORD_DEMO}`
      );
      await loadUsuarios();
    } catch (caughtError) {
      setError(
        ...
        <div className="mx-auto flex max-w-7xl flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-1 max-w-3xl text-xs leading-5 text-blue-100">
              Alta nominal de asistentes para sesión demostrativa. Esta pantalla
              permite crear accesos rápidos, controlar su estado y validar la
              entrada al entorno institucional.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div className="border-b border-slate-100 px-5 py-4">
              ...
              <p className="mt-1 text-xs leading-5 text-slate-500">
                Introduce el nombre de la persona asistente. El sistema genera
                un usuario nominal y asigna la contraseña común de esta sesión.
              </p>
            </div>
            ...
            <div className="px-5 py-4">
              ...
              <div className="mt-4 rounded-xl border border-amber-200 bg-amber-50 px-3 py-3 text-[11px] leading-5 text-amber-900">
                ...
                <p className="mt-1">
                  Crear un acceso nominal por asistente presente. La contraseña
                  común se utiliza solo para esta sesión demostrativa.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="px-5 py-4">
                        ...
                        >
                          ...
                          <td className="px-3 py-2.5 text-right">
                            <button
                              ...
                              className={
                                usuario.activo
                                  ? "rounded-full border border-red-100 bg-red-50 px-3 py-1 text-[10px] font-semibold text-red-700 hover:bg-red-100"
                                  : "rounded-full border border-blue-100 bg-blue-50 px-3 py-1 text-[10px] font-semibold text-blue-800 hover:bg-blue-100"
                              }
                            >
              ...
              <div className="mt-3 rounded-xl border border-slate-200 bg-slate-50 px-3 py-3 text-[11px] leading-5 text-slate-600">
                <p className="font-semibold text-slate-700">
                  Capa inicial de control de acceso
                </p>
                <p className="mt-1">
                  Para la sesión demo se habilitan accesos nominales rápidos con
                  control de estado. La capa completa de roles, permisos,
                  auditoría avanzada y gobierno de identidades quedaría para la
