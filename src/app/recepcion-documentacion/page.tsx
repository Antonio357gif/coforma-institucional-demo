                      ...
                      >
                        ...
                        <td className="px-2 py-1.5 text-right align-top">
                          <div className="flex flex-col items-end gap-1">
                            <Link
                              href={`/mesa-documental/${accion.subexpediente_id}`}
                              className="w-full rounded-lg border border-blue-200 bg-blue-50 px-2 py-1.5 text-center text-[10px] font-semibold text-blue-800 hover:bg-blue-100"
                            >
                              Mesa documental
                            </Link>

                            <Link
                              href={`/estado-pago/${accion.subexpediente_id}`}
                              className="w-full rounded-lg border border-violet-200 bg-violet-50 px-2 py-1.5 text-center text-[10px] font-semibold text-violet-800 hover:bg-violet-100"
                            >
                              Estado pago
                            </Link>
